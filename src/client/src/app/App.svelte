<script lang="ts">
  ...
  import TownMenu from '$features/town/TownMenu.svelte';
  import type { PlayerAction } from '$shared/types/game';
  import CombatOverlay from '$features/combat/CombatOverlay.svelte';
  import PartyStatusBar from '$features/party/PartyStatusBar.svelte';
  import ExplorationHUD from '$features/exploration/ExplorationHUD.svelte';
