...
public class SaveMigrationPipeline
{
    ...
    /// versions 3..9 only ever <em>added</em> back-compatible fields. No property was renamed,
    ...
    /// </summary>
    public static SaveMigrationPipeline CreateDefault(int targetVersion = 9)
    {
