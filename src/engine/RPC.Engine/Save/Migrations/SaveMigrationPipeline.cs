...
public class SaveMigrationPipeline
{
    ...
    /// versions 3..12 only ever <em>added</em> back-compatible fields. No property was renamed,
    ...
    /// </summary>
    public static SaveMigrationPipeline CreateDefault(int targetVersion = 12)
    {
